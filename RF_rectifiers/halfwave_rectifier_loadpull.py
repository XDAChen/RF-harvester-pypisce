...
def run_pi_match_optimization(verbose=True):
    ...
    - Bandwidth > 30 MHz centered at 2.437 GHz (WiFi Ch 6)
...
def run_frequency_stability():
    ...
    """
    print("\n" + "="*60)
    print("ANALYSIS 3b: FREQUENCY STABILITY (±20 MHz around 2.437 GHz)")
...
def run_monte_carlo(n_runs=50):
    ...
    - Via inductance: negligible at 2.437 GHz for short vias
